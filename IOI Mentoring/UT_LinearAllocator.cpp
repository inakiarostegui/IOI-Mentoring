...
namespace UT
{
    namespace Allocator
    {
        ...
        bool linear_prod()
        {
            ...
            AllocatorTestClass* data_0 = new (la.Allocate(sizeof(AllocatorTestClass))) AllocatorTestClass(1.2, 8);
            AllocatorTestClass* data_1 = new (la.Allocate(sizeof(AllocatorTestClass))) AllocatorTestClass(1.5, 10);

            la.Free();

            AllocatorTestClass* data_2 = new (la.Allocate(sizeof(AllocatorTestClass))) AllocatorTestClass(2.2, 5);
            AllocatorTestClass* data_3 = new (la.Allocate(sizeof(AllocatorTestClass))) AllocatorTestClass(2.6, 2);
